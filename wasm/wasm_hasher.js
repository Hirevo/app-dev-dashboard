...
(function (root, factory) {
    ...
    return (function (module_factory) {
        ...
        if (typeof window === "undefined" && typeof process === "object") {
            ...
            var wasm_path = path.join(__dirname, "wasm_hasher.wasm");
            var buffer = fs.readFileSync(wasm_path);
            var mod = new WebAssembly.Module(buffer);
            var wasm_instance = new WebAssembly.Instance(mod, instance.imports);
            return instance.initialize(wasm_instance);
        } else {
            return fetch("/wasm/wasm_hasher.wasm", { credentials: "same-origin" })
        ...
        return {
            ...
            initialize: function (instance) {
                ...
                Module.exports.sha512_hash = function sha512_hash(input) {
                    return Module.STDWEB_PRIVATE.acquire_tmp(Module.instance.exports.sha512_hash(Module.STDWEB_PRIVATE.prepare_any_arg(input)));
                }
                    ;
                __web_on_grow();
